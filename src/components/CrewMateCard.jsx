...
import { uploadImage, updateCrewmate, deleteCrewmate } from "../services";
...
const CrewMateCard = ({
  ...
  return (
    <div className="group bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden hover:border-gray-700 transition-all duration-300">
      {/* Image Section */}
      <div
        className="relative aspect-square bg-gray-800 overflow-hidden cursor-pointer"
          ...
          <>
            ...
            <div className="space-y-2 pt-2">
              ...
              <button
                ...
                className="w-full bg-red-600 hover:bg-red-700 text-white py-2 rounded-lg font-medium transition disabled:bg-gray-700 disabled:cursor-not-allowed"
              >
